 ...
 */
router.get('/', verifyToken, isAgent(), checkAnyModule, empruntController.getAllEmprunts);
 ...
 * @access  Private (agent+)
 */
router.get('/:id', verifyToken, isAgent(), checkAnyModule, empruntController.getEmpruntById);
 ...
 */
router.post('/', verifyToken, isAgent(), empruntController.createEmprunt);
 ...
 * @access  Private (agent+ - module vérifié dans le contrôleur selon l'item)
 */
router.post('/:id/retour', verifyToken, isAgent(), empruntController.retourEmprunt);
 ...
 * @access  Private (agent+ - module vérifié dans le contrôleur selon l'item)
 */
router.put('/:id', verifyToken, isAgent(), empruntController.updateEmprunt);
 ...
 */
router.delete('/:id', verifyToken, isAgent(), empruntController.deleteEmprunt);
